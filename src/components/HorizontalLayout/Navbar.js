            ...
            >
              <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <Link to="/cap-overview" className="dropdown-item">
                      {props.t("Overview")}
                    </Link>
                    <Link to="/cap-list" className="dropdown-item">
                      {props.t("List")}
                    </Link>
                    <Link to="/cap-manage" className="dropdown-item">
                      {props.t("Manage")}
                    </Link>
                  </div>
                </li>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <i className="ti-harddrives me-2"></i>
                    {props.t("Accelerators")}
                  </Link>
                  <div
                    className={classname("dropdown-menu", { show: component })}
                  >
                    <Link to="/acc-overview" className="dropdown-item">
                      {props.t("Overview")}
                    </Link>
                    <Link to="/acc-list" className="dropdown-item">
                      {props.t("List")}
                    </Link>
                    <Link to="/acc-manage" className="dropdown-item">
                      {props.t("Manage")}
                    </Link>
                  </div>
                </li>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    <Link to="/arc-manage" className="dropdown-item">
                      {props.t("Manage")}
                    </Link>
                  </div>
                </li>
